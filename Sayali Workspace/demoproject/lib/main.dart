 ...
 */
//Understanding of stateful and stateless widgets Counter app
/*
class MyHomePage extends StatefulWidget {
  @override
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: (){
                      var no1 = int.parse(no1Controller.text.toString());
                      var no2 = int.parse(no2Controller.text.toString());
                      var subtraction = no1 - no2;
                      result = "The difference of $no1 and $no2 is $subtraction";
                      setState(() {});
                    }, child: Text('Sub')),
                    ElevatedButton(onPressed: (){
                      var no1 = int.parse(no1Controller.text.toString());
                      ...
                      result = "The multiplication of $no1 and $no2 is $multiplication";
                      setState(() {});
                    }, child: Text('Mul')),
                    ElevatedButton(onPressed: (){
                      var no1 = int.parse(no1Controller.text.toString());
                      ...
                      result = "The division of $no1 and $no2 is ${division.toStringAsFixed(2)}";
                      setState(() {});
                    }, child: Text('Div'))
                  ],
                ),
